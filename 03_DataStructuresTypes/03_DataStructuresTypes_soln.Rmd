...
```{r}
## A SOLUTION
my_faves <- list("shannon", "blue", 6, TRUE)

# with names:
my_faves <- list(Name = "Shannon", Color = "blue", Number = 6, Fun = TRUE)
...
```{r}
## A SOLUTION
our_faves <- data.frame(Name = c("Shannon", "Kendall", "Nathan"),
                        Color = c("blue", "orange", "red"),
                        Number = c(6, 46, 64),
                        Fun = c(TRUE, TRUE, FALSE))
our_faves
